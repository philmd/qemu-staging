...
static int pmcr_read(CPUARMState *env, const ARMCPRegInfo *ri,
                     uint64_t *value)
{
    if (arm_current_pl(env) == 0 && !env->cp15.c9_pmuserenr) {
        return EXCP_UDEF;
    }
    *value = env->cp15.c9_pmcr;
    return 0;
}
...
static int pmcnten_read(CPUARMState *env, const ARMCPRegInfo *ri,
                        uint64_t *value)
{
    if (arm_current_pl(env) == 0 && !env->cp15.c9_pmuserenr) {
        return EXCP_UDEF;
    }
    *value = env->cp15.c9_pmcnten;
    return 0;
}
...
static int pmovsr_read(CPUARMState *env, const ARMCPRegInfo *ri,
                       uint64_t *value)
{
    if (arm_current_pl(env) == 0 && !env->cp15.c9_pmuserenr) {
        return EXCP_UDEF;
    }
    *value = env->cp15.c9_pmovsr;
    return 0;
}
...
static int pmxevtyper_read(CPUARMState *env, const ARMCPRegInfo *ri,
                           uint64_t *value)
{
    if (arm_current_pl(env) == 0 && !env->cp15.c9_pmuserenr) {
        return EXCP_UDEF;
    }
    *value = env->cp15.c9_pmxevtyper;
    return 0;
}
...
static const ARMCPRegInfo cp_reginfo[] = {
    ...
    { .name = "FCSEIDR", .crn = 13, .crm = 0, .opc1 = 0, .opc2 = 0,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.c13_fcse),
      .resetvalue = 0, .writefn = fcse_write },
    { .name = "CONTEXTIDR", .crn = 13, .crm = 0, .opc1 = 0, .opc2 = 1,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.c13_fcse),
      .resetvalue = 0, .writefn = contextidr_write },
    /* ??? This covers not just the impdef TLB lockdown registers but also
     * some v7VMSA registers relating to TEX remap, so it is overly broad.
     */
    { .name = "TLB_LOCKDOWN", .crn=10, .crm = CP_ANY,
...
static const ARMCPRegInfo v7_cp_reginfo[] = {
    ...
    { .name = "PMCR", .cp = 15, .crn = 9, .crm = 12, .opc1 = 0, .opc2 = 0,
      ...
      .readfn = pmcr_read, .writefn = pmcr_write },
    { .name = "PMCNTENSET", .cp = 15, .crn = 9, .crm = 12, .opc1 = 0, .opc2 = 1,
      .access = PL0_RW, .resetvalue = 0,
      .fieldoffset = offsetof(CPUARMState, cp15.c9_pmcnten),
      .readfn = pmcnten_read, .writefn = pmcntenset_write },
    { .name = "PMCNTENCLR", .cp = 15, .crn = 9, .crm = 12, .opc1 = 0, .opc2 = 2,
      .access = PL0_RW,
      .readfn = pmcnten_read, .writefn = pmcntenclr_write },
    { .name = "PMOVSR", .cp = 15, .crn = 9, .crm = 12, .opc1 = 0, .opc2 = 3,
      .access = PL0_RW,
      .readfn = pmovsr_read, .writefn = pmovsr_write },
    ...
    { .name = "PMXEVTYPER", .cp = 15, .crn = 9, .crm = 13, .opc1 = 0, .opc2 = 1,
      .access = PL0_RW,
      .readfn = pmxevtyper_read, .writefn = pmxevtyper_write },
    /* Unimplemented, RAZ/WI. XXX PMUSERENR */
...
static const ARMCPRegInfo t2ee_cp_reginfo[] = {
    /* TODO this should be doable as a FIELD if we support masks. */
...
static const ARMCPRegInfo arm1026_cp_reginfo[] = {
...
static const ARMCPRegInfo vmsa_cp_reginfo[] = {
    ...
    { .name = "TTBCR", .cp = 15, .crn = 2, .crm = 0, .opc1 = 0, .opc2 = 2,
      ...
      .fieldoffset = offsetof(CPUARMState, cp15.c2_control), .resetvalue = 0, },
...
static const ARMCPRegInfo omap_cp_reginfo[] = {
    ...
    { .name = "IMIN", .cp = 15, .crn = 15, .crm = 3, .opc1 = 0, .opc2 = 0,
      .access = PL1_RW,
      .fieldoffset = offsetof(CPUARMState, cp15.c15_i_min), .resetvalue = 0, },
...
static const ARMCPRegInfo cortexa9_cp_reginfo[] = {
    /* The config_base_address should hold the value of the peripheral
     * base. ARM should get this from a CPU object property, but that
     * support isn't available in December 2011. Default to 0 for now
     * and board models that care can set it by a private hook.
     */
    { .name = "A9_BASEADDR", .cp = 15, .crn = 15,  .crm = 0, .opc1 = 4,
      .opc2 = 0, .access = PL1_R|PL3_W, .resetvalue = 0,
...
static const ARMCPRegInfo cache_block_xfer_status_cp_reginfo[] = {
...
void register_cp_regs_for_features(ARMCPU *cpu)
{
    ...
    if (arm_feature(env, ARM_FEATURE_MPU)) {
         ...
         */
        if (arm_feature(env, ARM_FEATURE_V6)) {
            hw_error("PMSAv6 not implemented");
        }
    ...
    if (arm_feature(env, ARM_FEATURE_CACHE_BLOCK_OPS)) {
        define_arm_cp_regs(env, cache_block_xfer_status_cp_reginfo);
    }
